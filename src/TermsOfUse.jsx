        ...
        <div className="card">
            ...
            <ol className="legal-list">
                <li><strong>Purpose of the App:</strong><br />
                    BEERMATE is an entertainment app designed to help friends and family have fun together. The App does not promote or encourage alcohol consumption and is intended to promote a positive experience.
                </li>
                <li><strong>Responsible Use:</strong><br />
                ...
                <li><strong>Intellectual Property:</strong><br />
                    All content, features, and functionality of the App are the exclusive property of <em>10xDevsFromUmu</em>.
                </li>
